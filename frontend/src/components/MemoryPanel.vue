<template>
    <Teleport to="body">
        <div
            v-if="store.showMemoryPanel"
            class="overlay"
            @click.self="store.showMemoryPanel = false"
        >
            <div class="panel">
                <div class="panel-header">
                    <div class="panel-title">
                        ...
                        >
                            <path
                                d="M12 2a9 9 0 0 1 9 9c0 3.18-1.65 5.97-4.13 7.6L16 21H8l-.87-2.4A9 9 0 0 1 3 11a9 9 0 0 1 9-9z"
                            />
                    ...
                    <button
                        class="close-btn"
                        @click="store.showMemoryPanel = false"
                    >
                        <svg
                            width="16"
                            height="16"
                    ...
                    <div v-else class="memory-list">
                        ...
                        >
                            ...
                            <button
                                ...
                                title="删除此记忆"
                                @click="store.deleteMemory(item.id)"
                            >
                                <svg
                                    width="12"
                                    height="12"
